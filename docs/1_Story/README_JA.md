...
> さあ、あなたもこのチュートリアルでモナの夢の実現を手伝いましょう。GitHub Copilot の **Agent モード**を活用し、.NET 10（ASP.NET Core MVC）と SQLite でゼロから開発を進めていきます。Custom Instructions や Custom Agent を駆使して、チーム開発でも活きる実践的な Copilot の使い方を身につけましょう。
